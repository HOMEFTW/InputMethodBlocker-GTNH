...
- 当前版本：`0.2.1`
- 当前阶段：核心实现、native x64 重写、首批白名单兼容、AE2/AE2Things/AE2FluidCraft Rework、NEI、Twist Space Technology 与 Programmable Hatches 白名单补全已完成；AE2Things 无线连接终端、无线二合一接口终端与背包终端剩余焦点已补齐；原版与 Angelica 通用搜索白名单的 `func_146206_l` 焦点方法遗漏已修复；AE2、AE2Things、AE2FC 的选择数量界面已从焦点白名单排除，仍待 Windows 客户端实机复测
...
## 当前打包产物
- 运行用 jar：`build/libs/inputmethodblockergtnh-0.2.1.jar`
- 开发环境 jar：`build/libs/inputmethodblockergtnh-0.2.1-dev.jar`
- 源码 jar：`build/libs/inputmethodblockergtnh-0.2.1-sources.jar`
